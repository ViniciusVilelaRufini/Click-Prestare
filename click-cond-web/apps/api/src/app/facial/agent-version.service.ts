 ...
 * versão fora do fluxo normal do GitHub); senão o último release do GitHub
 * (`GET /repos/.../releases/latest`, tag `agent-v<versão>`, assets
...
const GITHUB_RELEASES_URL =
  'https://api.github.com/repos/Viniciusvile/Click-Prestare/releases/latest';
